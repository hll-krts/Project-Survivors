...
{
    [SerializeField] int WeaponLevel = 0, startingLevel = 0;
    [SerializeField] float baseProjectileCount = 1, baseFireRate = 2f;
    public float baseDamage = 10f, baseSpeed = 10f, baseLifeTime = 3f, projectileCount, pireRate;
    ...
    public void LevelWeaponUP()
    {
        ...
        switch (WeaponLevel)
        {
            ...
            case 5:
                ...
                break;
            case 6:
                normalAttackScript.damage += normalAttackScript.damage * 2;
                break;
        }
    }
