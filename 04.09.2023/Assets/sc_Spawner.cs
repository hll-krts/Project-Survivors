...
public class sc_Spawner : MonoBehaviour
{
    ...
    IEnumerator SpawnEnemies()
    {
        while(alive)
        {
            ...
            SpawnLoc.position = SpawnLoc.position + new Vector3(0, Random.Range(-10,11), 0);
            Instantiate(StandardWarriorPrefab, SpawnLoc.transform.position, SpawnLoc.transform.rotation);
        }
    }
