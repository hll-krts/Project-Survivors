...
{
    public float maxHP, healthPoints, ATK, speed, armor, healthRegen = 0.0f, coinGainPerChance = 10.0f, coinGainMultiplier = 1.0f, EXPoints = 0f, Level;
    public bool alive;
    [SerializeField] float baseMaxHP = 100f, baseATK = 50f, baseSPD = 8f, baseArmor = 10f, StartLevel = 0f;
    ...
    //------------------------------------------------------------------------------------------------------------------------------------------------
    //Dying, taking dmg, levelling etc.
    //------------------------------------------------------------------------------------------------------------------------------------------------
